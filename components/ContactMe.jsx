...
const Contact = () => {
  ...
  return (
    <div id="contact-me" className="m-5 pt-20">
      <div className="shadow-input  mx-auto my-10 w-full max-w-md rounded-lg border-[1px] bg-white/30 p-4 dark:bg-black md:rounded-2xl md:p-8 ">
